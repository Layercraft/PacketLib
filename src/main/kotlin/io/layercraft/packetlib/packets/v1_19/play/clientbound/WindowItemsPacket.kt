 ...
 * @see <a href="https://wiki.vg/Protocol#Set_Container_Content">https://wiki.vg/Protocol#Set_Container_Content</a>
 */

@MinecraftPacket(packetId = 0x11, state = PacketState.PLAY, direction = PacketDirection.CLIENTBOUND)
