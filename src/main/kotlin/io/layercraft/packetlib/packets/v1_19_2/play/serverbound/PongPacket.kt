 ...
 *
 * @property id id
 * @see <a href="https://wiki.vg/Protocol#Pong_.28play.29">https://wiki.vg/Protocol#Pong_.28play.29</a>
 */

@MinecraftPacket(packetId = 0x20, state = PacketState.PLAY, direction = PacketDirection.SERVERBOUND)
